...
export function SettingsModal({ isOpen, onClose, onOpenHelp }: SettingsModalProps) {
  ...
  return (
    ...
    >
  <div className="settings-root bg-background border border-border rounded-2xl shadow-2xl p-6 w-full max-w-md mx-4 mt-4 mb-4 animate-in zoom-in-95 duration-200">
        {/* Header */}
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 rounded-xl bg-card border border-border/50">
              <p className="text-sm text-muted-foreground">
                PAgentic Browser Agentic Assistant v{agentVersion}
              </p>
