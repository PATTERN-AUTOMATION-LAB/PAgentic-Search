  ...
  <div className="min-h-screen bg-background relative">
      ...
      <div className="min-h-screen flex flex-col items-center justify-center">
        <div className="w-full max-w-3xl px-4 -mt-20">
          {/* Marketing headline (styled) */}
          <div className="flex flex-col items-center justify-center mb-10 text-center hero-spot">
            <h1 className="text-4xl sm:text-5xl md:text-6xl leading-tight font-extralight text-foreground whitespace-nowrap">
              <span>A personal&nbsp;</span>
              <span className="text-[hsl(var(--primary))] font-semibold">PAgent</span>
              <span>&nbsp;Search</span>
            </h1>

            {/* Large centered icon under the headline */}
            <img
              src="/assets/pagentic.png"
              alt="PAgentic Logo"
              className="w-20 h-20 mt-8 drop-shadow-lg"
            />
            <p className="mt-4 text-sm text-muted-foreground">A new browser from PATTERN AUTOMATION.</p>
          </div>
