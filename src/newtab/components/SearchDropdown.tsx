...
function getProviderIcon(provider: Provider) {
  return provider.iconUrl || getFaviconFromPattern(provider.urlPattern) || '/assets/pagentic.png'
}
          ...
          >
            <img
              ...
              onError={e => {
                ...
                if (!img.src.endsWith('/assets/pagentic.png')) img.src = '/assets/pagentic.png'
              }}
            />
