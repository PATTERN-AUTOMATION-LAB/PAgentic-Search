...
const processEnv = {
  ...
  'process.env.BRAINTRUST_PROJECT_NAME': JSON.stringify(envKeys.BRAINTRUST_PROJECT_NAME || 'pagentic-browser-agent'),
...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: './pagentic-settings.html',
      filename: 'pagentic-settings.html',
      chunks: ['options']
    }),
    new CopyPlugin({
      patterns: [
